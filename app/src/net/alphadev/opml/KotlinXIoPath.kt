...
internal fun convertToPath(
    ...
    canBeFile: Boolean,
    canBeFolder: Boolean,
    @Suppress("unused") mustBeWritable: Boolean,
    @Suppress("unused") mustBeReadable: Boolean,
    @Suppress("unused") canBeSymlink: Boolean,
    ...
    return with(context.localization) {
        fileSystem.resolve(Path(path)).also {
            ...
            val metadata = fileSystem.metadataOrNull(it) ?: run {
                pathIsNotReadable(
                    name,
                    it.toString()
                )
            ...
            // TODO: implement me once https://github.com/Kotlin/kotlinx-io/issues/232 is done
...
//            )
            ...
            // TODO: implement me once https://github.com/Kotlin/kotlinx-io/issues/330 is done
